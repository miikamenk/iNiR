    ...
    SettingsCardSection {
        ...
        SettingsGroup {
            ...
            ConfigRow {
                ...
                ConfigSpinBox {
                    icon: "border_left"
                    text: Translation.tr("Left sidebar width")
                    value: Config.options?.sidebar?.widthLeft ?? 460
                    from: 320
                    to: 860
                    stepSize: 10
                    onValueChanged: Config.setNestedValue("sidebar.widthLeft", value)
                    StyledToolTip {
                        text: Translation.tr("Width of the left sidebar in pixels.\nYou can also drag its inner edge to resize it.")
                    }
                }
                ConfigSpinBox {
                    icon: "border_right"
                    text: Translation.tr("Right sidebar width")
                    value: Config.options?.sidebar?.widthRight ?? 460
                    from: 320
                    to: 860
                    stepSize: 10
                    onValueChanged: Config.setNestedValue("sidebar.widthRight", value)
                    StyledToolTip {
                        text: Translation.tr("Width of the right sidebar in pixels.\nYou can also drag its inner edge to resize it.")
                    }
                }
            }
